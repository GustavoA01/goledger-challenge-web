...
const tvShow = {
  ...
  recommendedAge: 16,
  rating: 8.7,
  description: "Um grupo de amigos descobre um mistério envolvendo contratos inteligentes e dimensões paralelas. A rede principal corre perigo e apenas eles possuem as chaves privadas para salvar o ecossistema.",
  seasons: [
    {
      number: 1,
      episodes: [
        { title: "Piloto", rating: 10, releaseDate: "2026-03-31", description: "Episódio piloto" },
        { title: "O Bloco Gênesis", rating: 9, releaseDate: "2026-04-07", description: "Continuação" }
      ]
    },
    {
      number: 2,
          ...
          <TabsContent value="seasons" className="space-y-8">
            {tvShow.seasons.map((season) => (
              <div key={season.number} className="space-y-4">
                <h2 className="text-2xl font-semibold">Temporada {season.number}</h2>
          ...
          <TabsContent value="watchlist">
            <Card>
              <CardContent className="p-8 text-center">
                <p className="text-muted-foreground">Adicione esta série à sua watchlist para acompanhar.</p>
